...
public class AppListAdapter extends ArrayAdapter<String> {
    ...
    public AppListAdapter(Context context, int textViewResourceId,
                          ArrayList<String> appName, ArrayList<CheckBox> checkName) {
                ...
                public void onClick(View v) {
                    ...
                    if(cb.isChecked() == true)
                    {
                        ...
                        cb.setSelected(cb.isChecked());
                                   /* if(app == null)
                                    {Toast.makeText(getContext(), "beadható", Toast.LENGTH_SHORT).show();}*/
                        selectedAppList.add(appList.get(position));
                    }
                    else
                    {
                        Toast.makeText(getContext().getApplicationContext(),
                                ...
                                Toast.LENGTH_LONG).show();
                        cb.setSelected(cb.isChecked());
                        selectedAppList.remove(appList.get(position));
                    }
    ...
    /*public ArrayList<String> CheckValidate()
    {
        for(CheckBox c:checked)
        {
            ...
            {
                selectedAppList.add(c.getTag().toString());
            }
